...
import '../function/favoriate_share.dart';
                  ...
                  slivers: [
                    ...
                    SliverList(
                      ...
                      Padding(
                        ...
                        child: Userreview(TvSeriesREview),
                      ),
                      Container(
                          padding: EdgeInsets.only(left: 10, top: 20),
                          child: Text("Status : ${TvSeriesDetails[0]['status']}")),
                      //created by
                      Container(
                          padding: EdgeInsets.only(left: 10, top: 20),
                      ...
                      Container(
                          padding: EdgeInsets.only(left: 10, top: 20),
                          child: Text("Total Seasons : ${tvseriesdetaildata['seasons'].length}")),
                      //airdate
                      Container(
                          padding: EdgeInsets.only(left: 10, top: 20),
                          child: Text("Release date : ${TvSeriesDetails[0]['releasedate']}")),
